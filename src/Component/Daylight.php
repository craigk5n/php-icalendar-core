...
/**
 * DAYLIGHT observance component for VTIMEZONE
 */
class Daylight extends AbstractComponent
{
    ...
    public function validate(): void
    {
        ...
        if ($dtstart === null) {
            throw new ValidationException('DAYLIGHT component missing required DTSTART property', ValidationException::ERR_TZ_OBSERVANCE_MISSING_DTSTART);
        }

        $tzOffsetTo = $this->getProperty('TZOFFSETTO');
        if ($tzOffsetTo === null) {
            throw new ValidationException('DAYLIGHT component missing required TZOFFSETTO property', ValidationException::ERR_TZ_OBSERVANCE_MISSING_TZOFFSETTO);
        }

        $tzOffsetFrom = $this->getProperty('TZOFFSETFROM');
        if ($tzOffsetFrom === null) {
            throw new ValidationException('DAYLIGHT component missing required TZOFFSETFROM property', ValidationException::ERR_TZ_OBSERVANCE_MISSING_TZOFFSETFROM);
        }
    }
