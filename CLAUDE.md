...
PHP iCalendar Parser and Writer Library - an RFC 5545 compliant PHP library for parsing and writing iCalendar data with zero external dependencies. Requires PHP >=8.1.
