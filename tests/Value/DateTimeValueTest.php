...
class DateTimeValueTest extends TestCase
{
    ...
    {
        $dateTime = new \DateTime('2026-02-06 00:00:00');
        $value = new DateTimeValue($dateTime);
        
        $this->assertEquals('20260206T000000', $value->serialize());
    }

    public function testSerializeWithEndOfDay(): void
    {
        $dateTime = new \DateTime('2026-02-06 23:59:59');
        $value = new DateTimeValue($dateTime);
        
        $this->assertEquals('20260206T235959', $value->serialize());
    }
    ...
    {
        $dateTime = new \DateTimeImmutable('2026-02-06 15:45:30');
        $value = new DateTimeValue($dateTime);
        
        $this->assertEquals('20260206T154530', $value->serialize());
        $this->assertSame($dateTime, $value->getValue());
    }
